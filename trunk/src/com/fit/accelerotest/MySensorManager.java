...
public class MySensorManager {
    ...
    public static boolean isSupported() {
    	Context context = AcceleroTest.getContext();
        if (supported == null) {
            if (context != null) {
    ...
    public static void configure(int threshold, int interval) {
        MySensorManager.threshold = threshold;
        MySensorManager.interval = interval;
    }
    ...
    public static void startListening(
            MySensorListener accelerometerListener) {
        sensorManager = (SensorManager) AcceleroTest.getContext().getSystemService(Context.SENSOR_SERVICE);
        List<Sensor> sensors = sensorManager.getSensorList(Sensor.TYPE_ACCELEROMETER);
        List<Sensor> sensors2 = sensorManager.getSensorList(Sensor.TYPE_MAGNETIC_FIELD);
